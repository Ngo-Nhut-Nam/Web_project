...
const DEFAULT_EXAMS = [
    {
        id: 'math',
        name: 'Toán học - Giữa kỳ 1',
        subject: 'math',
        questions: [
            {
                id: 1,
                text: 'Cho hàm số f(x) = x² - 4x + 3. Đạo hàm của hàm số tại x = 2 là:',
                options: ['0', '1', '2', '3'],
                answer: 0,
                explanation: 'f\'(x) = 2x - 4, f\'(2) = 2(2) - 4 = 0'
            },
            {
                id: 2,
                text: 'Phương trình x² - 5x + 6 = 0 có nghiệm là:',
                options: ['x=1 và x=6', 'x=2 và x=3', 'x=-2 và x=-3', 'x=0 và x=5'],
                answer: 1,
        ...
        numQuestions: 40,
        level: 'medium',
        description: 'Đề thi giữa kỳ môn Toán học lớp 12'
    },
    {
        id: 'physics',
        name: 'Vật lý - Chương 1',
        subject: 'physics',
        questions: [
            {
                id: 1,
                text: 'Một vật chuyển động thẳng đều với vận tốc 5 m/s. Quãng đường vật đi được sau 10 giây là:',
                options: ['5 m', '10 m', '50 m', '100 m'],
                answer: 2,
                explanation: 's = v × t = 5 × 10 = 50 m'
            }
        ],
        time: 45,
        numQuestions: 30,
        level: 'hard',
        description: 'Đề thi chương 1 môn Vật lý lớp 11'
    },
    {
        id: 'english',
        name: 'Tiếng Anh - Bài kiểm tra 1',
        subject: 'english',
        questions: [
            {
                id: 1,
                ...
                answer: 1,
                explanation: 'Present simple tense with third person singular (she)'
            }
        ],
        time: 75,
        numQuestions: 50,
        level: 'easy',
        description: 'Bài kiểm tra Tiếng Anh cơ bản'
    }
];
